...
| Static Type Checking | `uv run ty check` | Validate source code using [ty](https://docs.astral.sh/ty/) based on settings in `pyproject.toml`. | :white_check_mark: | :white_check_mark: (via [pre-commit](https://pre-commit.com/)) |
